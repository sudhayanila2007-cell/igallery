...
<body>
    <header style="text-align: center; background-color: #067746; color: white; padding: 1rem 0;">
        <h1>BLACK & WHITE WARRIOR</h1>
    </header>
    ...
    <div style="white-space: nowrap; overflow-x: auto; padding: 1rem;">
        ...
        <div style="display: inline-block; margin-right: 10px;" onclick="openModal(this)">
            <img src="img 3.jpg" style="height: 400px;">
        </div>
        <div style="display: inline-block;" onclick="openModal(this)">
            <img src="img 4.jpg" style="height: 400px;">
        </div>
        <div style="display: inline-block;" onclick="openModal(this)">
            <img src="img 5.jpg" style="height: 400px;">
    </div>
...
```
## OUTPUT:
![alt text](<Screenshot 2025-12-30 091514.png>)
